...
To start the application, use the **CargoflowJmix Jmix Application** run configuration in your IDE, or run the following command in the project root directory:
